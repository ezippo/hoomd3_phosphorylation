...
if __name__=='__main__':
    ...
    sim.create_state_from_gsd(filename='input_stats/ck1d-center-rescaled_multi-tdp43_start.gsd')
    ...
    sim.run(0)
    hoomd.write.GSD.write(state=sim.state, filename='input_stats/ck1d-rigid-rescaled_multi-tdp43_start.gsd')
